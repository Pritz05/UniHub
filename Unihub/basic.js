...
document.addEventListener("DOMContentLoaded", function () {
    if (document.body.classList.contains("student")) {
        ...
        document.getElementById("attendance").addEventListener("click", viewAttendance);
        document.getElementById("assignments").addEventListener("click", viewAssignments);
        document.getElementById("complaints").addEventListener("click", viewComplaints);
    }
});
